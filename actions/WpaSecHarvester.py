...
class WpaSecHarvester:
    ...
    def download_and_process_file(self):
        ...
        load_dotenv(self.shared_data.wpasec_env_path)
        ...
        if cookie_value and url:
            ...
            try:
                ...
                with open(self.shared_data.wpasec_potfile_path, "r", encoding="utf-8") as potfile:
        ...
        try:
            with open(self.shared_data.wpasec_cracked_path, "r", encoding="utf-8") as cracked_file:
        ...
        with open(self.shared_data.wpasec_networks_path, "w", encoding="utf-8") as output_file:
        ...
        if discord_webhook_url:
            try:
                with open(self.shared_data.wpasec_networks_path, "rb") as file:
    ...
    def process_networks(self):
        ...
        input_file = self.shared_data.wpasec_networks_path
        done_file = self.shared_data.wpasec_networks_done_path
